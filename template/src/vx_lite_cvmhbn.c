/** 
    vx_lite_%%cvmhbn% - A command line program to extract velocity values
    from %%CVMHBN% . Accepts Geographic Coordinates or UTM Zone 11 
    coordinates.
...
/* Usage function */
void usage() {
  printf("     vx_lite_%%cvmhbn% - (c) Harvard University, SCEC\n");
  ...
  printf("\tusage: vx_lite_%%cvmhbn% [-d] [-m dir] [-z dep/elev] < file.in\n\n");
  printf("Flags:\n");
